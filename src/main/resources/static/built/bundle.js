...
/***/ (function(module, exports, __webpack_require__) {
	...
	//
	//  handleClick(e) {
	//    //console.log("clicked on label row" + this.props.label.label + " on section: " + this.props.section.id);
	//    this.props.onLabelSelection(this.props.label, this.props.section);
	//  }
	//
	//  render() {
	//    const label = this.props.label
	//    return (
	//      <tr className="tblLabelRow" onClick={this.handleClick}>
	//        <td>{label.label}</td>
	//        <td>{label.translation}</td>
	//      </tr>);
	//  }
	//}
	//
	//function LabelList(props) {
	//  const labels = props.section.labels;
	//  const section = props.section;
	//  const onLabelSelection = props.onLabelSelection;
	//  const listItems = labels.map((label) =>
	//    <Label section={section} label={label} key={label.label} onLabelSelection={onLabelSelection}/>
	//  );
	//  return (
	...
	//      <LabelsHeader/>
	//      <LabelList section={section} onLabelSelection={onLabelSelection}/>
	//    </table>
	//  );
	//}
	//
	...
	//    <div>
	//      <h2>{section.name}</h2>
	//      <LabelSection section={section} onLabelSelection={onLabelSelection}/>
	//    </div>
	//  );
	//}
	//
	...
	//      <Section section={section} key={section.name} onLabelSelection={onLabelSelection}/>
	//  );
	//  return(
	//    <div className="row" style={divStyle} data-spy="scroll" data-target="#navbar-example">
	//      <div>{listItems}</div>
	//    </div>
	//  );
	//}
	...
	//  constructor(props) {
	//    super(props);
	//    this.handleSelectionLabel = this.handleSelectionLabel.bind(this);
	//    this.handleLabelEdited = this.handleLabelEdited.bind(this);
	//    this.state = {selectedLabel: null};
	//  }
	//
	//  handleSelectionLabel(label, section) {
	//    this.setState({selectedLabel: label, section: section});
	//  }
	//
	//  handleLabelEdited(labelDTO) {
	//    console.log("posting label: " + labelDTO.label + ", translation: " + labelDTO.translation);
	//    if (this.state.selectedLabel != null) {
	//      // update some label
	//      const sectionId = this.state.section.id;
	//      const project = this.props.project;
	//      axios.put('/API/project/' + project.id + '/label?sectionId=' + sectionId, labelDTO)
	//        .then((response) => {
	//          // this.props.onLabelUpdated(labelDTO, sectionId);
	//          console.log('Label updated');
	//        });
	//    } else {
	//      // create new
	//      // TODO
	//      axios.post('/API/project/' + project.id + '/label?sectionId=' + sectionId, labelDTO)
	//        .then((response) => this.createdLabel(response));
	//    }
	//  }
	//
	//  render() {
	...
	//        <div className="row">
	//          <h1 className="page-header">Editor</h1>
	//
	//          <LabelEditForm selectedLabel={selectedLabel} selectedSection={selectedSection}
	//                         onLabelUpdated={this.props.onLabelUpdated}
	//                         onLabelEdited={this.handleLabelEdited}/>
	//
	//          <button type="button" className="btn btn-success btn-lg" data-toggle="modal"
	//                  data-target="#mdlUploadNewSection">
	//            <span className="glyphicon glyphicon-plus" aria-hidden="true"></span> Upload file
	//          </button>
	//          <a href={ "/project/" + project.id + "/download"} className="btn btn-success btn-lg">
	//            Export all sections
	//          </a>
	//        </div>
	//        <Sections project={project} sections={sections} onLabelSelection={this.handleSelectionLabel}/>
	//      </div>);
	//  }
	//}
	//
	//function LateralSection(props) {
	//  const section = props.section
	//  return (
	...
	//}
	//
	//function LateralSectionList(props) {
	//  const sections = props.sections;
	//  const listItems = sections.map((section) =>
	//    <LateralSection section={section} key={section.name}/>
	//  );
	//  return (
	//    <div className="col-sm-3 col-md-2 sidebar" id="navbar-example">
	//      <ul className="nav nav-sidebar">{listItems} </ul>
	//    </div>
	//  );
	//}
	//
	...
	//    super(props);
	//    this.state = {sections: []};
	//    this.handleLabelUpdated = this.handleLabelUpdated.bind(this);
	//  }
	//
	//  componentDidMount() {
	//    axios.get('/API/project/' + this.props.projectid)
	//      .then((response) => this.receivedSectionsList(response));
	//  }
	//
	//  receivedSectionsList(response) {
	//    console.log(response);
	//    const loadedSections = [response.data[0], response.data[1]];
	//    this.setState({sections: loadedSections});
	//  }
	//
	//  handleLabelUpdated(label, sectionId) {
	//    var modifiedSection = this.state.sections.find(section => section.id == sectionId);
	//    var modifiedLabel = modifiedSection.labels.find(label => label.label ==  label.label);
	//    if (modifiedLabel === undefined) {
	//      console.log("Bad error can't find label by key: " + label.label);
	//    } else {
	//      modifiedLabel.translation = label.translation
	//    }
	...
	//    return (
	//      <div className="row">
	//        <LateralSectionList sections={this.state.sections}/>
	//        <EditorPanel sections={this.state.sections} project={project}
	//                     onLabelUpdated={this.handleLabelUpdated}/>
	//      </div>
	//    );
	//  }
	//}
